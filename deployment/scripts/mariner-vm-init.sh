...
sudo curl "https://unifiededgescenarios.blob.core.windows.net/arm-template/azure-percept-testdrive/latest/cafeteria.mkv" --output /home/localedgeuser/samples/input/cafeteria.mkv 
